...
1. Download or clone this [repostory](https://github.com/sadaf-Daneshgar/bookstore.git).
...
Feel free to check the [issues page](https://github.com/sadaf-Daneshgar/bookstore/issues).
...
If you like this project, kindly drop a start for the [repository](https://github.com/sadaf-Daneshgar/bookstore);
